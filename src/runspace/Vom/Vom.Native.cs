...
// shared texture (Reclaim = dp_close), a mapped section, an OS handle. Enumerable (the task manager),
...
public static unsafe partial class Vom
{
                                        ...
                                        string subdir = "Surfaces", string? name = null)
    {
        ...
        {
            RefCount = 1,
            Reclaim  = reclaim,   // the producer's close procedure (e.g. () => DirectPortNative.dp_close(h))
            Fence    = null,
        };
