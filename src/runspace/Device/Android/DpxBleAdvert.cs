...
// DpxBleAdvert — opt-in BLE discoverability + a GATT-relayed MCP endpoint, the LOWEST rung of the
...
// windows/DpxBleScan.cs): "Android-only advertise ... Windows never actively scans for BLE — it reaches
...
internal static class DpxBleAdvert
{
    [Flags]
    ...
    // Transport ladder (invariant 9): report the floor rung that's ALWAYS true here. A live DpxAoa/DpWinUsb
    // session negotiating a higher rung is out of this file's scope — a future pass wires DpxAoa.IsConnected
