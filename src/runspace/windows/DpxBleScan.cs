...
// DpxBleScan — pure Win32 P/Invoke GATT client for an ALREADY-PAIRED BLE device. Never scans for new/
// unpaired devices — see [[no-winrt-native-c-abi]] for why THAT specific piece needs WinRT and is closed
// out of scope. Pair the phone through Windows' normal "Add a Bluetooth device" flow once (DpxBleAdvert.cs
...
internal static class DpxBleScan
{
    // Same UUIDs Device/Android/DpxBleAdvert.cs advertises.
