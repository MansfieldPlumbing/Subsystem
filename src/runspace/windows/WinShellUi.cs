...
internal static class WinShellUi
{
    ...
    {
        // Launched windowless from the tray (or double-clicked), ss owns a PRIVATE console — hide it so only
        // the WinForms window shows, never a stray console. A terminal launch SHARES that console (>1 attached)
