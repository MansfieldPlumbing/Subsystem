 ...
 *             THE DEFAULT (owner directive 2026-06-19): a fresh install follows the OS appearance.
...
(function () {
  ...
  var DEFAULT_THEME = 'Dark';                          // fallback FLOOR bundle (clean dark); live default selection is Auto (below)
  var DEFAULTS = { theme: 'Auto', transparency: 1 };   // default = follow the OS dark/light (owner directive 2026-06-19)
  ...
  function apply(t) {
    ...
    // the XP skin sets it green). Its text defaults to the on-accent color so the glyph always contrasts.
